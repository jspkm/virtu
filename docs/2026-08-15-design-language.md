...
**Tools (5):** Fingering pencil (`PKInkType.pencil`), Highlighter (`PKInkType.marker`), Correction pen (`PKInkType.pen`), Text/stamp box, Eraser. Below: 4 ink swatches, 28pt circles, selected state = 2pt ring offset 3pt outside + `.selection` haptic.
